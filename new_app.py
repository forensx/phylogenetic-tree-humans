...
@app.callback(Output('cytoscape-tapNodeMode-output', 'children'),
                [Input('cytoscape-event-callbacks-2', 'tapNodeData')])
def displayTapNodeData(data):
    if data:
...
@app.callback(Output('cytoscape-tapNodeCranial-output', 'children'),
                [Input('cytoscape-event-callbacks-2', 'tapNodeData')])
def displayTapNodeData(data):
    if data:
...
@app.callback(Output('cytoscape-tapNodeOrigin-output', 'children'),
                [Input('cytoscape-event-callbacks-2', 'tapNodeData')])
def displayTapNodeData(data):
    if data:
...
@app.callback(Output('cytoscape-tapNodeDead-output', 'children'),
                [Input('cytoscape-event-callbacks-2', 'tapNodeData')])
def displayTapNodeData(data):
    if data:
...
@app.callback(Output('cytoscape-tapNodeHabitat-output', 'children'),
                [Input('cytoscape-event-callbacks-2', 'tapNodeData')])
def displayTapNodeData(data):
    if data:
...
@app.callback(Output('cytoscape-tapNodeGeography-output', 'children'),
                [Input('cytoscape-event-callbacks-2', 'tapNodeData')])
def displayTapNodeData(data):
    if data:
...
@app.callback(Output('cytoscape-tapNodeFossil-output', 'children'),
                [Input('cytoscape-event-callbacks-2', 'tapNodeData')])
def displayTapNodeData(data):
    if data:
